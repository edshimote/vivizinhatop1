...
import eyesImg from "../assets/vivi-eyes.png.asset.json";
import curlsImg from "../assets/vivi-curls.png.asset.json";
import magnificaImg from "../assets/vivi-magnifica.png.asset.json";
import pinkImg from "../assets/vivi-pink.png.asset.json";
import starsImg from "../assets/vivi-stars.png.asset.json";
      ...
      {eyePositions.map((p, i) => (
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${eyesImg.url})`,
              backgroundSize: "400% 400%",
              backgroundPosition: `${(i % 2) * 100}% ${Math.floor(i / 2) * 33}%`,
      ...
      <section className="relative px-6 py-24 md:py-32">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2">
            {[
              { src: pinkImg.url, rotate: -3, caption: "estrelinha rosa" },
              { src: starsImg.url, rotate: 3, caption: "cheia de estrelas" },
            ].map((it, i) => (
              <motion.figure
                key={i}
      ...
      <section className="relative px-6 py-24 md:py-32">
        <div className="mx-auto max-w-2xl text-center">
          <motion.p
            ...
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            className="text-xs tracking-[0.4em] uppercase text-primary/70"
            style={{ fontFamily: "'Quicksand', sans-serif" }}
          >
            pra escutar
          </motion.p>
          <motion.h2
            ...
            viewport={{ once: true }}
            transition={{ duration: 1 }}
            className="mt-4 text-4xl md:text-5xl italic text-foreground/90"
            style={{ fontFamily: "'Cormorant Garamond', serif" }}
          >
            uma musiquinha nossa
          </motion.h2>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 1 }}
            className="mt-10 rounded-3xl border border-primary/30 bg-card/70 backdrop-blur p-10 shadow-xl"
          >
            <motion.div
            ...
            <p className="mt-4 italic text-foreground/70">
              [cole aqui o link da música que combina com ela ✿]
            </p>
          </motion.div>
        </div>
      </section>

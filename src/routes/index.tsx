      ...
      <section className="relative px-6 py-24 md:py-32">
        ...
        <div className="mx-auto mt-16 grid max-w-5xl items-center gap-10 md:grid-cols-2 md:gap-16">
          <motion.div
            ...
            className="relative z-10 mx-auto max-w-sm md:mx-0"
          >
          ...
          <motion.p
            ...
            className="relative z-10 text-center text-lg md:text-left md:text-xl italic leading-relaxed text-foreground/80"
            style={{ fontFamily: "'Cormorant Garamond', serif" }}
          >
            Simplesmente a mulher mais bela que eu já conheci. Ainda não tive
            oportunidade de te ver sem suas maquiagens, mas pode ter certeza
            que beijaria cada parte do seu rostinho igual xuxu.
          </motion.p>
        </div>
      </section>
